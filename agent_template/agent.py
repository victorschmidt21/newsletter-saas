...
idea = dedent("""
<div class="idea">
    <div class="idea-title">Ferramenta de geração de ideias para SaaS</div>
    <p class="idea-desc">Uma ferramenta para ajudar a gerar ideias de negócios de SaaS.</p>
    <p class="idea-reason"><strong>Vale a pena porque:</strong> pode ajudar empreendedores a encontrar oportunidades de negócios inovadoras.</p>
</div>
              """)
